                ...
                <div className="booking-form ">
                    <form onSubmit={() => handleSubmit(name)}>
                        <div className="form-group">
                                ...
                                <input type="text" className="form-control input-field" id="origin" placeholder={pickFrom} required></input>
                        </div>
                        <div className="form-group">
                            <label htmlFor="destination">Pick To</label>
                            <input type="text" className="form-control input-field" id="destination" placeholder={pickTo} required></input>
                        </div>
                        <div style={{display: 'flex', marginBottom: '10px'}}>
                            <div>
                                <label htmlFor="start">Date</label>
                                <input type="date" className="form-control input-field-date" id="start" name="trip-start"
                                min="2021-03-19" max="" required></input>
                            </div>
                                </div>
                    ...
                    {handleSubmit(name)
                        setIsClicked(true) 
                     }} className="booking-btn btn-warning"> Search                  
            {
              isClicked ?
                <div>
                   {checkOut.map((spot) => <CheckOut key={spot.name} spot={spot} />)}
             <div className="container ">
              ...
              <div className="col-6 mb-3">
               <div className="card p-3 ">
                ...
                <div style={{overflow: 'hidden'}} className="col-lg-6 google-map px-5 ">
